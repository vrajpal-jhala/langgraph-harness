...
// Brackets a message's reasoning phase — id matches the MessageEvent(s) it reasoned into, so the
// UI can compute a reasoning duration without relying on array position relative to that message.
