...
<template>
  <div class="screencast" @mousemove="started && showControls()">
    <img :src="poster" :alt="alt ?? 'Screencast preview'" class="screencast-media" />
    ...
    <button v-if="!started" type="button" class="screencast-play" aria-label="Play video" @click="start">
    ...
    <div v-if="started" class="screencast-controls">
      <button type="button" class="screencast-btn" :aria-label="isPlaying ? 'Pause' : 'Play'" @click="togglePlay">
      ...
      <span class="screencast-time">{{ formatTime(currentTime) }} / {{ formatTime(duration) }}</span>

      <button type="button" class="screencast-btn" :aria-label="isMuted ? 'Unmute' : 'Mute'" @click="toggleMute">
      ...
      <button type="button" class="screencast-btn" aria-label="Fullscreen" @click="toggleFullscreen">
